...
context_length = int(sys.argv[20])
maximum_coverage_to_call_snp = int(sys.argv[21])

snp_filter_path = sys.argv[22]
gc_filter_path = sys.argv[23]
snp_distances_path = sys.argv[24]
runs_of_homozygosity_path = sys.argv[25]
single_reads_fastq_path = sys.argv[26]
multiple_reads_fastq_path = sys.argv[27]
control_path = sys.argv[28]
